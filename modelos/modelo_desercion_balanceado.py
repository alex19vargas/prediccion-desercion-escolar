# Predicción de Deserción Escolar - Dataset Balanceado (75/25)
...
# Definir ruta base de resultados - NUEVA CARPETA PARA MODELO BALANCEADO
RESULTADOS_BASE = os.path.join(os.path.dirname(__file__), '..', 'resultados', 'modelo_balanceado')
...
# RUTA DEL NUEVO DATASET BALANCEADO (75/25)
...
def cargar_datos(path):
    ...
    """
    # Leer Excel con dataset balanceado
...
def main():
    try:
        ...
        print("="*80)
        print("🎯 MODELO DE DESERCIÓN ESCOLAR - DATASET BALANCEADO (75/25)")
        print("="*80)
        ...
        print(f"📊 Total de modelos a entrenar: {len(modelos)}")
        print("="*80)
        ...
        if resultados_comparativos:
            print("\n" + "="*80)
            print("📊 TABLA COMPARATIVA DE TODOS LOS MODELOS - DATASET BALANCEADO")
            print("="*80)
        ...
        print(f"📂 Resultados guardados en: {RESULTADOS_BASE}")
        print("="*80)
